...
StatusRemocao fundir_com_irmao_esquerdo(Arv23 **ponteiro_filho_no_pai, Arv23 *pai, Arv23 *irmao_esq) {
    ...
    // Salva filhos do no em underflow
    ...
    // Realiza fusao no irmao esquerdo
    irmao_esq->info2 = chave_pai_desce;
    irmao_esq->nInfo = 2;
    irmao_esq->dir = filho_u_esq; // Primeiro filho do no em underflow
